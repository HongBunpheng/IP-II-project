    ...
    <div class="container">
      ...
      <div class="side">
        ...
        <div v-if="showDropdown" class="dropdown">
          ...
          <div class="dropdown-item" :class="{ active: myPlaceType === 'restaurant' }" @click="loadData('restaurant')">
      ...
      <div class="main">
          ...
          <div v-if="selectedType === 'Hotel'" class="form-container">
            ...
            <form class="hotel-form" @submit.prevent="submitHotelForm">
              ...
              <div class="form-row">
                ...
                <input type="file" multiple @change="e => handleFileChange(e, 'detail_image', 'hotel')" />
              </div>
          ...
          <div v-if="selectedType === 'Restaurant'" class="form-container">
            ...
            <form class="hotel-form" @submit.prevent="submitRestaurantForm">
              ...
              <div class="form-row">
                ...
                <label>Detail Images</label>
                <input type="file" multiple @change="e => handleFileChange(e, 'detail_image', 'restaurant')" />
              </div>
        ...
        <div v-if="myPlaceType === 'hotel'" class="data-list">
          ...
          <div v-for="(item, index) in myPlaceData" :key="index" class="data-card">
            ...
            <img v-for="(img, i) in item.image" :key="'img' + i" :src="`${baseURL}/storage/${img}`"
              class="data-image" />
            <img v-for="(img, i) in item.detail_image" :key="'detail' + i" :src="`${baseURL}/storage/${img}`"
              class="data-image" />

            <!-- Edit & Delete Buttons -->
            <div class="action-buttons">
              <button @click="editHotel(item)"> Edit</button>

              <button class="delete-btn" @click="deleteHotel(item.id)">Delete</button>
            </div>
          </div>
        </div>
        ...
        <div v-if="myPlaceType === 'restaurant'" class="data-list">
          ...
          <div v-for="(item, index) in myPlaceData" :key="index" class="data-card">
            ...
            <!-- Edit & Delete Buttons -->
            <div class="action-buttons">
              <button @click="editRestaurant(item)">Edit</button>
...
const editingHotelId = ref(null) // track if editing
...
const submitHotelForm = async () => {
  ...
  try {
    if (editingHotelId.value) {
      ...
      await axios.post(`${baseURL}/api/hotels/${editingHotelId.value}`, formData, {
...
const editHotel = (item) => {
  editingHotelId.value = item.id
  selectedType.value = 'Hotel'
  showCreateSection.value = true
  hotel.value = { ...item, image: [], detail_image: [] }
}
...
const editRestaurant = (item) => {
  editingRestaurantId.value = item.id
